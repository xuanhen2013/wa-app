...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn("inline-flex items-center gap-2 font-heading text-base font-medium text-foreground", className)}
      {...props}
    />
  )
}
